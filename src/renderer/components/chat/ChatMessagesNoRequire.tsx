...
function ChatMessagesNoRequire(props: {
  ...
  console.log('chatMessages mount:', chatMessages);
  ...
  console.log('initial Load chatMessages', chatMessages.length);
  useEffect(() => {
  ...
  return (
    ...
    >
      <Button
        ...
        href="/chat/Hi!%20I%20am%20a%20test%20message%20from%20the%20chat"
        onClick={() => {
        ...
        >
          ...
          >
            ...
            <ListItemText
              ...
              primary={<Box>{streamResponse}</Box>}
              secondary={
                <div>
...
export default ChatMessagesNoRequire;
